...
![](https://cdn.jsdelivr.net/gh/samuelwnb/imgbed/blog/mipi4.png)
...
![](https://cdn.jsdelivr.net/gh/samuelwnb/imgbed/blog/mipi1.jpg)

CSI/DSI分别是指其承载的是针对Camera或Display应用，都有复杂的协议结构。以DSI为例，其协议层结构如下：

![](https://cdn.jsdelivr.net/gh/samuelwnb/imgbed/blog/mipi2.JPG)
...
![](https://cdn.jsdelivr.net/gh/samuelwnb/imgbed/blog/mipi3.png)
...
![](https://cdn.jsdelivr.net/gh/samuelwnb/imgbed/blog/mipi5.png)
...
![](https://cdn.jsdelivr.net/gh/samuelwnb/imgbed/blog/mipi6.png)
...
![](https://cdn.jsdelivr.net/gh/samuelwnb/imgbed/blog/mipi7.jpg)

这个是上电的sequence，包括前面的电压配置（不同电压之间的延时），reset sequence ， MIPI data&clock  ， command  ，最后是数据传输


![](https://cdn.jsdelivr.net/gh/samuelwnb/imgbed/blog/mipi8.jpg)
